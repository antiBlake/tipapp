  ...
  return (
    <div className='tip md:m-auto md:w-5/12'>
        <div className='tip-body h-auto w-12/12'>
            <h2 className='text-center mt-20 text-4xl font-sans text-teal-800 font-bold '>TIP APP</h2>

        </div>
        <div className='calculate w-12/12 mt-20 bg-white rounded-t-3xl p-6'>
            <div className='input-amount flex flex-col w-full'>
                <h1 className='text-gray-400 mb-4 font-medium'>Bill</h1>
                <div className='input '>
                    <input type='number' className='border rounded-md px-4 w-full text-right h-10 bg-gray-100 text-2xl text-teal-900'
                    name='bill'
            ...
            <h1 className='text-gray-400 mb-4 font-medium'>Select Tip %</h1>
            <div className='percent-box grid grid-cols-2 gap-2 justify-items-center'>
                <div className='box-1 flex justify-center items-center bg-teal-900 w-10/12 h-12 rounded-md text-white text-2xl font-medium hover:bg-teal-500 hover:text-teal-900' onClick={()=>{
        let calculateamount = (formData.bill * 5)/100
        setAmount(calculateamount)
        let total = calculateamount * formData.numberpeople
        setTotal(total)
        ...
        setTotal(total)
                    ...
                    <input type='number' className='border rounded-md px-4 w-full text-right h-12 bg-gray-100 text-2xl text-teal-900 placeholder:text-teal-900' placeholder='Custom'
                    name='custom'
                    onChange={handleChange}
            ...
            <div className='input-amount flex flex-col w-full my-8'>
                <h1 className='text-gray-400 mb-4 font-medium'>Number of people</h1>
                <div className='input '>
                    <input type='number' className='border rounded-md px-4 w-full text-right h-10 bg-gray-100 text-2xl text-teal-900'
                    name='numberpeople'
                    onChange={handleChange}
            ...
            <div className='calculated w-full rounded-lg bg-teal-900 text-white p-4 pt-8 grid grid-cols-1'>
                ...
                <button className='bg-teal-500 text-teal-900 rounded-md w-11/12 m-auto font-bold mt-8 h-12' onClick={handleSubmit}>RESET</button>
